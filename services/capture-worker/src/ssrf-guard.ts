// Duplicate of lib/server/ssrf-guard.ts — capture-worker is a standalone npm
// project outside the pnpm workspace (see services/capture-worker/package.json),
// so it cannot import from the monorepo. Keep both in sync if the logic changes.
