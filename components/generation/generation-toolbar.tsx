...
import { Bot, Brain, Check, Globe, Globe2, Search } from 'lucide-react';
...
import { SourceLibraryPopover } from '@/components/generation/source-library-popover';
    ...
    <div className="flex items-center gap-1 flex-wrap">
      ...
      <div className="flex min-w-0 items-center gap-1">
        ...
        <SourceLibraryPopover
          ...
          triggerClassName={pillMuted}
          activeTriggerClassName={pillActive}
        />
