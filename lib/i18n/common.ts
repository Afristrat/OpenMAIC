...
export const commonEnUS = {
  ...
  certificate: {
    ...
    notFoundDetail: 'No certificate matches this verification code. Please check the code and try again.',
...
export const commonFrFR = {
  ...
  certificate: {
    ...
    notFoundDetail: 'Aucun certificat ne correspond à ce code de vérification. Veuillez vérifier le code et réessayer.',
...
export const commonArMA = {
  ...
  certificate: {
    ...
    notFoundDetail: 'لا توجد شهادة مطابقة لرمز التحقّق هذا. يُرجى التحقّق من الرمز والمحاولة مجددًا.',
