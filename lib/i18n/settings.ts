export const settingsZhCN = {
  settings: {
    ...
    providerVoxcpmTTS: 'VoxCPM TTS',
    providerHiggsTTS: 'Higgs Audio (Dīwān)',
    providerMinimaxTTS: 'MiniMax TTS',
    providerLemonadeTTS: 'Lemonade TTS',
    providerLemonadeASR: 'Lemonade ASR',
    providerAzureASR: 'Azure ASR',
...
export const settingsFrFR = {
  settings: {
    ...
    addProviderDescription:
      'Ajouter des fournisseurs personnalisés pour étendre les modèles IA disponibles',
    providerNames: {
      openai: 'OpenAI',
      anthropic: 'Claude',
      google: 'Gemini',
    ...
    activeModelDescription:
      'Choisir le modèle utilisé pour les conversations IA et la génération de contenu',
    ...
    asrEnabledDescription:
      'Les apprenants pourront utiliser le micro pour dicter leurs interventions',
    ...
    browserNativeNote:
      "L'ASR natif du navigateur ne nécessite aucune configuration et est entièrement gratuit",
    // Audio provider names
    providerOpenAITTS: 'OpenAI TTS (gpt-4o-mini-tts)',
    providerAzureTTS: 'Azure TTS',
    providerGLMTTS: 'GLM TTS',
    ...
    providerDoubaoTTS: 'Doubao TTS 2.0 (Volcengine)',
    providerElevenLabsTTS: 'ElevenLabs TTS',
    providerEdgeTTS: 'Edge TTS (Gratuit)',
    ...
    videoGenerationWarning:
      'La génération de vidéo prend généralement 1 à 2 minutes — merci de patienter',
...
export const settingsArMA = {
  settings: {
    ...
    resetToDefaultDescription: 'استعادة قائمة النماذج الافتراضية (سيُحتفظ بمفتاح API و Base URL)',
    resetConfirmDescription:
    ...
    configureProvidersFirst: 'يُرجى ضبط إعدادات الاتصال في « مزوّدو النماذج » على اليسار أولًا',
    ...
    ttsVoiceConfigHint: 'يمكن ضبط صوت كل وكيل من « إعداد أدوار الفصل » على الصفحة الرئيسية',
    ...
    providerDoubaoTTS: 'Doubao TTS 2.0 (Volcengine)',
    providerElevenLabsTTS: 'ElevenLabs TTS',
    providerEdgeTTS: 'Edge TTS (مجاني)',
    ...
    providerLemonadeASR: 'Lemonade ASR',
    providerAzureASR: 'Azure ASR',
    providerOpenAIImage: 'OpenAI للصور',
    providerMinimaxImage: 'MiniMax للصور',
    providerLemonadeImage: 'Lemonade',
    ...
    pdfDescription: 'اختَر محرك تحليل PDF مع دعم استخراج النصوص ومعالجة الصور والتعرف على الجداول',
    ...
    mineruWarning: 'تنبيه',
    mineruCostWarning: 'MinerU خدمة مدفوعة وقد تترتب عليها رسوم. راجع موقع MinerU لمعرفة الأسعار.',
    ...
    imageGenerationDisabledHint: 'عند التفعيل، تُولَّد الصور تلقائيًا أثناء إنشاء الدرس',
    ...
    videoGenerationDisabledHint: 'عند التفعيل، تُولَّد الفيديوهات تلقائيًا أثناء إنشاء الدرس',
    ...
    clearCacheConfirmDescription: 'ستُحذف جميع البيانات التالية نهائيًا دون إمكانية استردادها:',
    clearCacheConfirmItems:
