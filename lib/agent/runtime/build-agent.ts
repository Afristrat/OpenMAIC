...
export function buildSystemPrompt(
  ...
  return [
    ...
    'For French slide text and French presenter notes, never use an em dash (—) or en dash (–). Use normal French punctuation such as a comma, colon, semicolon, parentheses, or a full stop instead.',
