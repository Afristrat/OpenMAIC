...
const demo1Scene1Slides: Slide[] = [
  makeSlide('d1s1-slide1', THEME_FR, [
    ...
    textEl(
      'd1s1-s1-stat1',
      '<strong>78 % de p\u00e9n\u00e9tration mobile</strong> au Maroc \u2014 le smartphone est le premier \u00e9cran',
      {
        left: 80,
        top: 230,
        width: 840,
    ...
    textEl(
      'd1s1-s1-stat2',
      '<strong>+42 % de croissance e-commerce</strong> en Afrique du Nord depuis 2024',
      {
        left: 80,
        top: 290,
        width: 840,
    ...
    textEl(
      'd1s1-s1-stat3',
      "<strong>Co\u00fbt d'acquisition 5x moins cher</strong> qu'en marketing traditionnel",
      {
        left: 80,
        top: 350,
        width: 840,
    ...
    textEl(
      'd1s1-s1-takeaway',
      "Le digital n'est plus une option : c'est le canal principal pour atteindre vos clients.",
      {
        left: 80,
        top: 440,
        width: 840,
  ...
  makeSlide('d1s1-slide2', THEME_FR, [
    ...
    textEl(
      'd1s1-s2-p1',
      '<strong>SEO & Contenu</strong><br/>Cr\u00e9ez du contenu qui r\u00e9pond aux recherches de vos clients. Blog, vid\u00e9os, guides \u2014 soyez la r\u00e9ponse \u00e0 leurs questions.',
      {
        left: 80,
        top: 140,
        width: 380,
    ...
    textEl(
      'd1s1-s2-p2',
      '<strong>R\u00e9seaux sociaux</strong><br/>Instagram, TikTok, LinkedIn \u2014 choisissez 2 plateformes max et publiez r\u00e9guli\u00e8rement. La constance bat la perfection.',
      {
        left: 520,
        top: 140,
        width: 400,
    ...
    textEl(
      'd1s1-s2-footer',
      'Ma\u00eetriser ces 4 piliers = 80 % de votre strat\u00e9gie digitale',
      {
        left: 80,
        top: 480,
        width: 840,
  ...
  makeSlide('d1s1-slide3', THEME_FR, [
    ...
    textEl(
      'd1s1-s3-e1',
      '<strong>\u00catre partout \u00e0 la fois</strong><br/>Mieux vaut 2 canaux bien g\u00e9r\u00e9s que 6 canaux abandonn\u00e9s apr\u00e8s 2 semaines.',
      {
        left: 80,
        top: 150,
        width: 840,
    ...
    textEl(
      'd1s1-s3-e2',
      "<strong>Copier les grandes marques</strong><br/>Vous n'avez pas le budget de Coca-Cola. Misez sur l'authenticit\u00e9 et la proximit\u00e9 avec votre audience.",
      {
        left: 80,
        top: 240,
        width: 840,
    ...
    textEl(
      'd1s1-s3-e3',
      "<strong>Ignorer les donn\u00e9es</strong><br/>Chaque campagne doit \u00eatre mesur\u00e9e. Pas de donn\u00e9es = pas d'am\u00e9lioration. Installez Google Analytics d\u00e8s le jour 1.",
      {
        left: 80,
        top: 330,
        width: 840,
...
const demo1Scene1Actions: Action[] = [
  speechAction(
    'd1s1-a1',
    'Bienvenue dans cette formation sur le marketing digital pour startups. Le paysage num\u00e9rique en Afrique du Nord a radicalement chang\u00e9 ces derni\u00e8res ann\u00e9es. Avec 78 pour cent de p\u00e9n\u00e9tration mobile au Maroc, le digital est devenu le canal principal pour toucher vos clients.',
  ),
  spotlightAction('d1s1-a2', 'd1s1-s1-stat1'),
  speechAction(
    'd1s1-a3',
    "Le e-commerce a connu une croissance de 42 pour cent, et le co\u00fbt d'acquisition client en ligne est 5 fois moins cher qu'en marketing traditionnel. C'est une opportunit\u00e9 immense pour les startups.",
  ),
...
const demo1Scene1b: SceneRecord = {
  ...
  actions: [
    speechAction(
      'd1s1b-a1',
      "Parlons maintenant des quatre piliers du marketing digital. Le SEO et le contenu pour \u00eatre trouv\u00e9. Les r\u00e9seaux sociaux pour cr\u00e9er une communaut\u00e9. L'email marketing, qui reste le canal avec le meilleur retour sur investissement. Et la publicit\u00e9 cibl\u00e9e pour acc\u00e9l\u00e9rer votre croissance.",
    ),
    spotlightAction('d1s1b-a2', 'd1s1-s2-p1'),
    spotlightAction('d1s1b-a3', 'd1s1-s2-p3'),
    speechAction(
      'd1s1b-a4',
      "L'email marketing rapporte en moyenne 36 dirhams pour chaque dirham investi. Commencez \u00e0 construire votre liste d'emails d\u00e8s le premier jour.",
    ),
  ],
  createdAt: Date.now() - 86400000 * 3,
  updatedAt: Date.now() - 86400000 * 3,
...
const demo1Scene1c: SceneRecord = {
  ...
  actions: [
    speechAction(
      'd1s1c-a1',
      "Attention aux erreurs fatales que commettent la plupart des startups. \u00catre partout \u00e0 la fois, copier les grandes marques sans avoir leur budget, et ignorer les donn\u00e9es. La r\u00e8gle d'or, c'est de tester, mesurer et ajuster chaque semaine.",
    ),
...
const demo1Scene2: SceneRecord = {
    ...
    questions: [
      {
        ...
        type: 'single',
        question:
          'Quel est le canal digital avec le meilleur retour sur investissement (ROI) pour une startup ?',
        options: [
        ...
        answer: ['B'],
        analysis:
          "L'email marketing offre en moyenne un ROI de 36:1, ce qui en fait le canal le plus rentable. Contrairement aux r\u00e9seaux sociaux, vous \u00eates propri\u00e9taire de votre liste d'emails \u2014 aucun algorithme ne peut r\u00e9duire votre port\u00e9e.",
        hasAnswer: true,
        points: 2,
      },
      {
        ...
        type: 'single',
        question:
          'Combien de plateformes de r\u00e9seaux sociaux une startup devrait-elle g\u00e9rer activement au d\u00e9marrage ?',
        options: [
        ...
        answer: ['B'],
        analysis:
          "Se concentrer sur 2 \u00e0 3 plateformes permet de maintenir une pr\u00e9sence constante et qualitative. \u00catre partout \u00e0 la fois dilue les efforts et m\u00e8ne souvent \u00e0 l'abandon apr\u00e8s quelques semaines.",
        hasAnswer: true,
        points: 2,
      },
      {
        ...
        type: 'short_answer',
        question:
          "Qu'est-ce que le SEO et pourquoi est-il important pour une startup avec un budget limit\u00e9 ?",
        commentPrompt:
          "Le candidat doit mentionner que le SEO (Search Engine Optimization / R\u00e9f\u00e9rencement naturel) permet d'obtenir du trafic organique gratuit depuis les moteurs de recherche, ce qui est crucial pour une startup qui ne peut pas d\u00e9pendre uniquement de la publicit\u00e9 payante.",
        analysis:
          "Le SEO (r\u00e9f\u00e9rencement naturel) consiste \u00e0 optimiser votre site web pour appara\u00eetre dans les r\u00e9sultats de recherche Google. C'est crucial pour les startups car le trafic organique est gratuit et durable \u2014 contrairement \u00e0 la publicit\u00e9 qui s'arr\u00eate d\u00e8s que vous coupez le budget.",
        hasAnswer: false,
        points: 3,
      },
      {
        ...
        answer: ['C'],
        analysis:
          "Avec 78 % de p\u00e9n\u00e9tration mobile, le Maroc est l'un des march\u00e9s les plus connect\u00e9s d'Afrique du Nord. Cela signifie que votre strat\u00e9gie digitale doit \u00eatre \u00ab mobile-first \u00bb \u2014 votre site et vos contenus doivent \u00eatre optimis\u00e9s pour les smartphones.",
        hasAnswer: true,
        points: 1,
      },
      {
        ...
        answer: ['B'],
        analysis:
          "Google Analytics est indispensable d\u00e8s le jour 1. Sans mesure, vous ne pouvez pas savoir ce qui fonctionne. Chaque d\u00e9cision marketing doit \u00eatre guid\u00e9e par les donn\u00e9es, pas par l'intuition.",
        hasAnswer: true,
        points: 2,
      },
    ],
  ...
  actions: [
    speechAction(
      'd1s2-a1',
      'Testons maintenant vos connaissances sur les fondamentaux du marketing digital. Ce quiz comporte 5 questions m\u00ealant choix unique et r\u00e9ponse courte. Prenez votre temps pour r\u00e9fl\u00e9chir \u00e0 chaque question.',
    ),
  ],
  createdAt: Date.now() - 86400000 * 3,
  updatedAt: Date.now() - 86400000 * 3,
...
const demo1Scene3: SceneRecord = {
  ...
  actions: [
    speechAction(
      'd1s3-a1',
      "Passons \u00e0 la pratique avec ce calculateur de budget marketing. Ajustez les curseurs pour r\u00e9partir votre budget entre les quatre canaux principaux et observez les estimations de retour sur investissement. N'oubliez pas que l'email marketing offre le meilleur ROI.",
    ),
  ],
  createdAt: Date.now() - 86400000 * 3,
  updatedAt: Date.now() - 86400000 * 3,
...
const demo1Scene4Slides = {
  ...
  month3: makeSlide('d1s4-slide3', THEME_FR, [
    ...
    textEl(
      'd1s4-s3-kpi',
      'KPI : 2 000 visiteurs/mois, 500 abonn\u00e9s email, 1 000 followers, premiers clients',
      {
        left: 80,
        top: 500,
        width: 840,
...
const demo1Scene4a: SceneRecord = {
  ...
  actions: [
    speechAction(
      'd1s4a-a1',
      "Voici votre plan d'action sur 90 jours. Le premier mois est consacr\u00e9 aux fondations : cr\u00e9er votre site web, installer les outils d'analyse, et \u00e9tablir votre pr\u00e9sence sur les r\u00e9seaux sociaux. L'objectif est d'atteindre 100 visiteurs et 20 abonn\u00e9s email.",
    ),
  ],
  createdAt: Date.now() - 86400000 * 3,
  updatedAt: Date.now() - 86400000 * 3,
...
const demo1Scene4b: SceneRecord = {
  ...
  actions: [
    speechAction(
      'd1s4b-a1',
      'Le deuxi\u00e8me mois, on acc\u00e9l\u00e8re. Vous lancez vos premi\u00e8res publicit\u00e9s avec un budget modeste de 50 dirhams par jour. Vous cr\u00e9ez un lead magnet pour capturer des emails, et vous testez les collaborations avec des micro-influenceurs locaux.',
    ),
  ],
  createdAt: Date.now() - 86400000 * 3,
  updatedAt: Date.now() - 86400000 * 3,
...
const demo1Scene4c: SceneRecord = {
  ...
  actions: [
    speechAction(
      'd1s4c-a1',
      "Le troisi\u00e8me mois est celui de l'optimisation. Doublez le budget des campagnes rentables, cr\u00e9ez des s\u00e9quences d'email automatis\u00e9es, et lancez un programme de parrainage. \u00c0 la fin des 90 jours, vous devriez avoir 2 000 visiteurs mensuels et vos premiers clients.",
    ),
  ],
  createdAt: Date.now() - 86400000 * 3,
  updatedAt: Date.now() - 86400000 * 3,
...
const demo2Stage: StageRecord = {
  ...
  description:
    '\u0645\u0642\u062f\u0645\u0629 \u0634\u0627\u0645\u0644\u0629 \u0641\u064a \u0631\u064a\u0627\u062f\u0629 \u0627\u0644\u0623\u0639\u0645\u0627\u0644 \u0645\u0648\u062c\u0647\u0629 \u0644\u0644\u0634\u0628\u0627\u0628 \u0641\u064a \u0634\u0645\u0627\u0644 \u0623\u0641\u0631\u064a\u0642\u064a\u0627 \u0648\u0627\u0644\u0634\u0631\u0642 \u0627\u0644\u0623\u0648\u0633\u0637. \u062a\u063a\u0637\u064a \u0627\u0644\u0641\u0631\u0635 \u0627\u0644\u062d\u0627\u0644\u064a\u0629\u060c \u0645\u0646\u0647\u062c\u064a\u0629 \u0627\u0644\u0634\u0631\u0643\u0629 \u0627\u0644\u0646\u0627\u0634\u0626\u0629 \u0627\u0644\u0631\u0634\u064a\u0642\u0629\u060c \u0648\u062e\u0637\u0648\u0627\u062a \u0639\u0645\u0644\u064a\u0629 \u0644\u0644\u0627\u0646\u0637\u0644\u0627\u0642.',
...
const demo2Scene1a: SceneRecord = {
  ...
  content: {
    ...
    canvas: makeSlide('d2s1-slide1', THEME_AR, [
      ...
      textEl(
        'd2s1-s1-stat1',
        '<strong>\u0623\u0643\u062b\u0631 \u0645\u0646 60% \u0645\u0646 \u0633\u0643\u0627\u0646 \u0634\u0645\u0627\u0644 \u0623\u0641\u0631\u064a\u0642\u064a\u0627 \u062a\u062d\u062a \u0633\u0646 30</strong> \u2014 \u062c\u064a\u0644 \u0631\u0642\u0645\u064a \u0628\u0627\u0644\u0643\u0627\u0645\u0644',
        {
          left: 80,
          top: 160,
          width: 840,
      ...
      textEl(
        'd2s1-s1-stat2',
        '<strong>\u0646\u0645\u0648 \u0627\u0644\u062a\u0645\u0648\u064a\u0644 \u0644\u0640 startups \u0623\u0641\u0631\u064a\u0642\u064a\u0627 +35% \u0633\u0646\u0648\u064a\u0627\u064b</strong> \u0645\u0646\u0630 2023',
        {
          left: 80,
          top: 230,
          width: 840,
      ...
      textEl(
        'd2s1-s1-stat3',
        '<strong>\u062a\u0643\u0644\u0641\u0629 \u0625\u0637\u0644\u0627\u0642 \u0645\u0634\u0631\u0648\u0639 \u0631\u0642\u0645\u064a \u0627\u0646\u062e\u0641\u0636\u062a 10 \u0645\u0631\u0627\u062a</strong> \u0645\u0642\u0627\u0631\u0646\u0629 \u0628\u0639\u0627\u0645 2015',
        {
          left: 80,
          top: 300,
          width: 840,
      ...
      textEl(
        'd2s1-s1-takeaway',
        '\u0627\u0644\u0641\u0631\u0635\u0629 \u062d\u0642\u064a\u0642\u064a\u0629. \u0627\u0644\u0633\u0624\u0627\u0644 \u0644\u064a\u0633 \u00ab\u0647\u0644\u00bb \u0628\u0644 \u00ab\u0643\u064a\u0641\u00bb \u0648\u00ab\u0645\u062a\u0649\u00bb',
        {
          left: 80,
          top: 410,
          width: 840,
  ...
  actions: [
    speechAction(
      'd2s1a-a1',
      '\u0645\u0631\u062d\u0628\u0627\u064b \u0628\u0643\u0645 \u0641\u064a \u0647\u0630\u0647 \u0627\u0644\u062f\u0648\u0631\u0629 \u062d\u0648\u0644 \u0623\u0633\u0627\u0633\u064a\u0627\u062a \u0631\u064a\u0627\u062f\u0629 \u0627\u0644\u0623\u0639\u0645\u0627\u0644. \u0646\u062d\u0646 \u0646\u0639\u064a\u0634 \u0641\u062a\u0631\u0629 \u0627\u0633\u062a\u062b\u0646\u0627\u0626\u064a\u0629: \u0623\u0643\u062b\u0631 \u0645\u0646 \u0633\u062a\u064a\u0646 \u0628\u0627\u0644\u0645\u0626\u0629 \u0645\u0646 \u0633\u0643\u0627\u0646 \u0634\u0645\u0627\u0644 \u0623\u0641\u0631\u064a\u0642\u064a\u0627 \u062a\u062d\u062a \u0633\u0646 \u0627\u0644\u062b\u0644\u0627\u062b\u064a\u0646\u060c \u0648\u0627\u0644\u062a\u0645\u0648\u064a\u0644 \u0644\u0644\u0634\u0631\u0643\u0627\u062a \u0627\u0644\u0646\u0627\u0634\u0626\u0629 \u0641\u064a \u062a\u0632\u0627\u064a\u062f \u0645\u0633\u062a\u0645\u0631. \u062a\u0643\u0644\u0641\u0629 \u0625\u0637\u0644\u0627\u0642 \u0645\u0634\u0631\u0648\u0639 \u0631\u0642\u0645\u064a \u0627\u0646\u062e\u0641\u0636\u062a \u0639\u0634\u0631 \u0645\u0631\u0627\u062a \u0645\u0642\u0627\u0631\u0646\u0629 \u0628\u0639\u0627\u0645 \u0623\u0644\u0641\u064a\u0646 \u0648\u062e\u0645\u0633\u0629 \u0639\u0634\u0631.',
    ),
...
const demo2Scene1b: SceneRecord = {
  ...
  content: {
    ...
    canvas: makeSlide('d2s1-slide2', THEME_AR, [
      ...
      textEl(
        'd2s1-s2-story1',
        '<strong>Chari (\u0627\u0644\u0645\u063a\u0631\u0628)</strong><br/>\u0645\u0646\u0635\u0629 B2B \u0644\u0644\u062a\u062c\u0627\u0631\u0629 \u0627\u0644\u0625\u0644\u0643\u062a\u0631\u0648\u0646\u064a\u0629 \u2014 \u062c\u0645\u0639\u062a \u0623\u0643\u062b\u0631 \u0645\u0646 100 \u0645\u0644\u064a\u0648\u0646 \u062f\u0648\u0644\u0627\u0631. \u0628\u062f\u0623\u062a \u0628\u0641\u0643\u0631\u0629 \u0628\u0633\u064a\u0637\u0629: \u062a\u0633\u0647\u064a\u0644 \u0627\u0644\u062a\u0648\u0631\u064a\u062f \u0644\u0644\u0645\u062a\u0627\u062c\u0631 \u0627\u0644\u0635\u063a\u064a\u0631\u0629.',
        {
          left: 80,
          top: 140,
          width: 840,
      ...
      textEl(
        'd2s1-s2-story2',
        '<strong>Swvl (\u0645\u0635\u0631)</strong><br/>\u062d\u0644 \u0645\u0634\u0643\u0644\u0629 \u0627\u0644\u0646\u0642\u0644 \u0627\u0644\u062c\u0645\u0627\u0639\u064a \u0641\u064a \u0627\u0644\u0642\u0627\u0647\u0631\u0629. \u0645\u0646 \u062d\u0627\u0641\u0644\u0629 \u0648\u0627\u062d\u062f\u0629 \u0625\u0644\u0649 \u0634\u0631\u0643\u0629 \u0639\u0627\u0644\u0645\u064a\u0629 \u0645\u062f\u0631\u062c\u0629 \u0641\u064a \u0627\u0644\u0628\u0648\u0631\u0635\u0629.',
        {
          left: 80,
          top: 260,
          width: 840,
      ...
      textEl(
        'd2s1-s2-story3',
        '<strong>Expensya (\u062a\u0648\u0646\u0633)</strong><br/>\u0628\u0631\u0646\u0627\u0645\u062c \u0625\u062f\u0627\u0631\u0629 \u0627\u0644\u0645\u0635\u0627\u0631\u064a\u0641 \u2014 \u0648\u0635\u0644 \u0644\u0623\u0643\u062b\u0631 \u0645\u0646 5000 \u0639\u0645\u064a\u0644 \u0641\u064a 100 \u062f\u0648\u0644\u0629. \u0628\u062f\u0623 \u0641\u064a \u062a\u0648\u0646\u0633 \u0648\u062a\u0648\u0633\u0639 \u0639\u0627\u0644\u0645\u064a\u0627\u064b.',
        {
          left: 80,
          top: 380,
          width: 840,
      ...
      textEl(
        'd2s1-s2-lesson',
        '\u0627\u0644\u062f\u0631\u0633: \u0627\u0644\u0645\u0634\u0627\u0643\u0644 \u0627\u0644\u0645\u062d\u0644\u064a\u0629 \u064a\u0645\u0643\u0646 \u0623\u0646 \u062a\u0635\u0628\u062d \u0641\u0631\u0635\u0627\u064b \u0639\u0627\u0644\u0645\u064a\u0629',
        {
          left: 80,
          top: 490,
          width: 840,
  ...
  actions: [
    speechAction(
      'd2s1b-a1',
      '\u062f\u0639\u0648\u0646\u0627 \u0646\u0644\u0642\u064a \u0646\u0638\u0631\u0629 \u0639\u0644\u0649 \u0642\u0635\u0635 \u0646\u062c\u0627\u062d \u062d\u0642\u064a\u0642\u064a\u0629 \u0645\u0646 \u0645\u0646\u0637\u0642\u062a\u0646\u0627. \u0634\u0631\u0643\u0629 \u0634\u0627\u0631\u064a \u0641\u064a \u0627\u0644\u0645\u063a\u0631\u0628 \u062c\u0645\u0639\u062a \u0623\u0643\u062b\u0631 \u0645\u0646 \u0645\u0626\u0629 \u0645\u0644\u064a\u0648\u0646 \u062f\u0648\u0644\u0627\u0631. \u0648\u0633\u0648\u064a\u0641\u0644 \u0641\u064a \u0645\u0635\u0631 \u062d\u0644\u062a \u0645\u0634\u0643\u0644\u0629 \u0627\u0644\u0646\u0642\u0644 \u0648\u0623\u0635\u0628\u062d\u062a \u0634\u0631\u0643\u0629 \u0639\u0627\u0644\u0645\u064a\u0629. \u0648\u0625\u0643\u0633\u0628\u0646\u0633\u064a\u0627 \u0645\u0646 \u062a\u0648\u0646\u0633 \u0648\u0635\u0644\u062a \u0644\u062e\u0645\u0633\u0629 \u0622\u0644\u0627\u0641 \u0639\u0645\u064a\u0644 \u0641\u064a \u0645\u0626\u0629 \u062f\u0648\u0644\u0629. \u0627\u0644\u062f\u0631\u0633 \u0647\u0648 \u0623\u0646 \u0627\u0644\u0645\u0634\u0627\u0643\u0644 \u0627\u0644\u0645\u062d\u0644\u064a\u0629 \u064a\u0645\u0643\u0646 \u0623\u0646 \u062a\u0635\u0628\u062d \u0641\u0631\u0635\u0627\u064b \u0639\u0627\u0644\u0645\u064a\u0629.',
    ),
  ],
  createdAt: Date.now() - 86400000 * 2,
  updatedAt: Date.now() - 86400000 * 2,
...
const demo2Scene1c: SceneRecord = {
  ...
  content: {
    ...
    canvas: makeSlide('d2s1-slide3', THEME_AR, [
      ...
      textEl(
        'd2s1-s3-p1',
        '<strong>\u0628\u0631\u0627\u0645\u062c \u062d\u0643\u0648\u0645\u064a\u0629</strong><br/>\u0627\u0644\u0645\u063a\u0631\u0628: \u0625\u0646\u0637\u0644\u0627\u0642\u0629\u060c \u0645\u0631\u0648\u062c | \u0645\u0635\u0631: Creativa | \u062a\u0648\u0646\u0633: Startup Act<br/>\u062a\u0645\u0648\u064a\u0644 \u0648\u0625\u0639\u0641\u0627\u0621\u0627\u062a \u0636\u0631\u064a\u0628\u064a\u0629 \u0648\u0645\u0633\u0627\u062d\u0627\u062a \u0639\u0645\u0644 \u0645\u062c\u0627\u0646\u064a\u0629',
        {
          left: 80,
          top: 140,
          width: 400,
      ...
      textEl(
        'd2s1-s3-p2',
        '<strong>\u062d\u0627\u0636\u0646\u0627\u062a \u0648\u0645\u0633\u0631\u0651\u0639\u0627\u062a</strong><br/>Technopark (\u0627\u0644\u0645\u063a\u0631\u0628) | Flat6Labs (\u0645\u0635\u0631) | Wiki Startup (\u062a\u0648\u0646\u0633)<br/>\u0625\u0631\u0634\u0627\u062f \u0648\u062a\u0648\u0627\u0635\u0644 \u0645\u0639 \u0645\u0633\u062a\u062b\u0645\u0631\u064a\u0646',
        {
          left: 520,
          top: 140,
          width: 400,
      ...
      textEl(
        'd2s1-s3-p3',
        '<strong>\u0645\u0635\u0627\u062f\u0631 \u0627\u0644\u062a\u0645\u0648\u064a\u0644</strong><br/>\u0635\u0646\u0627\u062f\u064a\u0642 \u0627\u0633\u062a\u062b\u0645\u0627\u0631 \u0625\u0642\u0644\u064a\u0645\u064a\u0629 (\u0645\u062b\u0644 212 Founders, Algebra Ventures)<br/>\u062a\u0645\u0648\u064a\u0644 \u062c\u0645\u0627\u0639\u064a \u0639\u0628\u0631 \u0627\u0644\u0625\u0646\u062a\u0631\u0646\u062a<br/>\u0628\u0631\u0627\u0645\u062c \u0645\u0646\u062d \u062f\u0648\u0644\u064a\u0629 (\u0645\u062b\u0644 Orange Corners, Afrilabs)',
        {
          left: 80,
          top: 300,
          width: 840,
      ...
      textEl(
        'd2s1-s3-bottom',
        '\u0644\u0633\u062a \u0648\u062d\u062f\u0643 \u2014 \u0647\u0646\u0627\u0643 \u0646\u0638\u0627\u0645 \u0628\u064a\u0626\u064a \u0643\u0627\u0645\u0644 \u064a\u062f\u0639\u0645\u0643',
        {
          left: 80,
          top: 470,
          width: 840,
  ...
  actions: [
    speechAction(
      'd2s1c-a1',
      '\u0627\u0644\u0628\u064a\u0626\u0629 \u0627\u0644\u062f\u0627\u0639\u0645\u0629 \u0644\u0631\u064a\u0627\u062f\u0629 \u0627\u0644\u0623\u0639\u0645\u0627\u0644 \u0641\u064a \u0627\u0644\u0645\u0646\u0637\u0642\u0629 \u0623\u0635\u0628\u062d\u062a \u0623\u0642\u0648\u0649 \u0645\u0646 \u0623\u064a \u0648\u0642\u062a \u0645\u0636\u0649. \u0628\u0631\u0627\u0645\u062c \u062d\u0643\u0648\u0645\u064a\u0629 \u0645\u062b\u0644 \u0625\u0646\u0637\u0644\u0627\u0642\u0629 \u0641\u064a \u0627\u0644\u0645\u063a\u0631\u0628\u060c \u062d\u0627\u0636\u0646\u0627\u062a \u0645\u062b\u0644 \u062a\u0643\u0646\u0648\u0628\u0627\u0631\u0643 \u0648\u0641\u0644\u0627\u062a \u0633\u064a\u0643\u0633 \u0644\u0627\u0628\u0632\u060c \u0648\u0635\u0646\u0627\u062f\u064a\u0642 \u0627\u0633\u062a\u062b\u0645\u0627\u0631 \u0625\u0642\u0644\u064a\u0645\u064a\u0629. \u0644\u0633\u062a \u0648\u062d\u062f\u0643 \u0641\u064a \u0647\u0630\u0647 \u0627\u0644\u0631\u062d\u0644\u0629.',
    ),
  ],
  createdAt: Date.now() - 86400000 * 2,
  updatedAt: Date.now() - 86400000 * 2,
...
const demo2Scene2: SceneRecord = {
  ...
  type: 'quiz',
  title:
    '\u0627\u062e\u062a\u0628\u0627\u0631 \u2014 \u0645\u0646\u0647\u062c\u064a\u0629 \u0627\u0644\u0634\u0631\u0643\u0629 \u0627\u0644\u0646\u0627\u0634\u0626\u0629 \u0627\u0644\u0631\u0634\u064a\u0642\u0629',
  order: 3,
  content: {
    type: 'quiz',
    questions: [
      {
        ...
        options: [
          {
            label:
              '\u0627\u0644\u0645\u0646\u062a\u062c \u0627\u0644\u0646\u0647\u0627\u0626\u064a \u0627\u0644\u0643\u0627\u0645\u0644 \u062c\u0627\u0647\u0632 \u0644\u0644\u0633\u0648\u0642',
            value: 'A',
          },
          {
            label:
              '\u0623\u0628\u0633\u0637 \u0646\u0633\u062e\u0629 \u0645\u0646 \u0627\u0644\u0645\u0646\u062a\u062c \u062a\u062d\u0644 \u0627\u0644\u0645\u0634\u0643\u0644\u0629 \u0627\u0644\u0623\u0633\u0627\u0633\u064a\u0629 \u0648\u062a\u0633\u0645\u062d \u0628\u062c\u0645\u0639 \u0645\u0644\u0627\u062d\u0638\u0627\u062a \u0627\u0644\u0639\u0645\u0644\u0627\u0621',
            value: 'B',
          },
          {
            label:
              '\u0646\u0645\u0648\u0630\u062c \u0623\u0648\u0644\u064a \u0644\u0627 \u064a\u0639\u0645\u0644 \u0641\u0639\u0644\u064a\u0627\u064b',
            value: 'C',
          },
          {
            label:
        ...
        answer: ['B'],
        analysis:
          '\u0627\u0644\u0645\u0646\u062a\u062c \u0627\u0644\u0642\u0627\u0628\u0644 \u0644\u0644\u062a\u0637\u0628\u064a\u0642 \u0627\u0644\u0623\u062f\u0646\u0649 (MVP) \u0647\u0648 \u0623\u0628\u0633\u0637 \u0646\u0633\u062e\u0629 \u0645\u0646 \u0645\u0646\u062a\u062c\u0643 \u062a\u062d\u0644 \u0627\u0644\u0645\u0634\u0643\u0644\u0629 \u0627\u0644\u0623\u0633\u0627\u0633\u064a\u0629. \u0627\u0644\u0647\u062f\u0641 \u0644\u064a\u0633 \u0628\u0646\u0627\u0621 \u0645\u0646\u062a\u062c \u0643\u0627\u0645\u0644\u060c \u0628\u0644 \u0627\u062e\u062a\u0628\u0627\u0631 \u0641\u0631\u0636\u064a\u062a\u0643 \u0645\u0639 \u0623\u0642\u0644 \u062c\u0647\u062f \u0648\u062a\u0643\u0644\u0641\u0629 \u0645\u0645\u0643\u0646\u0629\u060c \u0648\u062c\u0645\u0639 \u0645\u0644\u0627\u062d\u0638\u0627\u062a \u062d\u0642\u064a\u0642\u064a\u0629 \u0645\u0646 \u0627\u0644\u0645\u0633\u062a\u062e\u062f\u0645\u064a\u0646 \u0644\u062a\u062d\u0633\u064a\u0646 \u0627\u0644\u0645\u0646\u062a\u062c.',
        hasAnswer: true,
        points: 2,
      },
      {
        ...
        type: 'single',
        question:
          '\u0645\u0627 \u0647\u064a \u062d\u0644\u0642\u0629 \u00ab\u0627\u0628\u0646\u0650 \u2014 \u0642\u0650\u0633 \u2014 \u062a\u0639\u0644\u0651\u0645\u00bb (Build-Measure-Learn)\u061f',
        options: [
          {
            label:
              '\u0628\u0646\u0627\u0621 \u0627\u0644\u0645\u0646\u062a\u062c \u0627\u0644\u0643\u0627\u0645\u0644 \u062b\u0645 \u0642\u064a\u0627\u0633 \u0627\u0644\u0645\u0628\u064a\u0639\u0627\u062a \u062b\u0645 \u062a\u0639\u0644\u0645 \u0623\u0633\u0628\u0627\u0628 \u0627\u0644\u0641\u0634\u0644',
            value: 'A',
          },
          {
            label:
              '\u062f\u0648\u0631\u0629 \u0645\u062a\u0643\u0631\u0631\u0629: \u0628\u0646\u0627\u0621 \u0646\u0633\u062e\u0629 \u0633\u0631\u064a\u0639\u0629\u060c \u0642\u064a\u0627\u0633 \u0627\u0633\u062a\u062c\u0627\u0628\u0629 \u0627\u0644\u0633\u0648\u0642\u060c \u062a\u0639\u0644\u0645 \u0645\u0646 \u0627\u0644\u0628\u064a\u0627\u0646\u0627\u062a\u060c \u062b\u0645 \u062a\u0643\u0631\u0627\u0631 \u0627\u0644\u0639\u0645\u0644\u064a\u0629',
            value: 'B',
          },
          {
            label:
              '\u062a\u0639\u0644\u0645 \u0627\u0644\u0628\u0631\u0645\u062c\u0629 \u062b\u0645 \u0628\u0646\u0627\u0621 \u062a\u0637\u0628\u064a\u0642 \u062b\u0645 \u0642\u064a\u0627\u0633 \u0627\u0644\u0623\u0631\u0628\u0627\u062d',
            value: 'C',
          },
          {
            label:
              '\u0643\u062a\u0627\u0628\u0629 \u062e\u0637\u0629 \u0639\u0645\u0644\u060c \u0642\u064a\u0627\u0633 \u0627\u0644\u062a\u0643\u0627\u0644\u064a\u0641\u060c \u062a\u0639\u0644\u0645 \u0639\u0646 \u0627\u0644\u0645\u0646\u0627\u0641\u0633\u064a\u0646',
            value: 'D',
          },
        ],
        answer: ['B'],
        analysis:
          '\u062d\u0644\u0642\u0629 \u0627\u0628\u0646\u0650-\u0642\u0650\u0633-\u062a\u0639\u0644\u0651\u0645 \u0647\u064a \u062c\u0648\u0647\u0631 \u0645\u0646\u0647\u062c\u064a\u0629 Lean Startup. \u0627\u0644\u0641\u0643\u0631\u0629 \u0623\u0646 \u062a\u0628\u0646\u064a \u0628\u0633\u0631\u0639\u0629\u060c \u062a\u0642\u064a\u0633 \u0627\u0633\u062a\u062c\u0627\u0628\u0629 \u0627\u0644\u0633\u0648\u0642 \u0628\u0627\u0644\u0628\u064a\u0627\u0646\u0627\u062a (\u0648\u0644\u064a\u0633 \u0627\u0644\u0627\u0641\u062a\u0631\u0627\u0636\u0627\u062a)\u060c \u062a\u062a\u0639\u0644\u0645 \u0645\u0646 \u0627\u0644\u0646\u062a\u0627\u0626\u062c\u060c \u062b\u0645 \u062a\u0643\u0631\u0631 \u0627\u0644\u0639\u0645\u0644\u064a\u0629. \u0643\u0644 \u062f\u0648\u0631\u0629 \u064a\u062c\u0628 \u0623\u0646 \u062a\u0643\u0648\u0646 \u0623\u0633\u0631\u0639 \u0645\u0646 \u0633\u0627\u0628\u0642\u062a\u0647\u0627.',
        hasAnswer: true,
        points: 2,
      },
      {
        ...
        type: 'single',
        question:
          '\u0645\u0627\u0630\u0627 \u064a\u0639\u0646\u064a \u00ab\u0627\u0644\u0645\u062d\u0648\u0631\u00bb (Pivot) \u0641\u064a \u0639\u0627\u0644\u0645 \u0627\u0644\u0634\u0631\u0643\u0627\u062a \u0627\u0644\u0646\u0627\u0634\u0626\u0629\u061f',
        options: [
          {
            label:
              '\u0625\u063a\u0644\u0627\u0642 \u0627\u0644\u0634\u0631\u0643\u0629 \u0648\u0627\u0644\u0628\u062f\u0621 \u0645\u0646 \u0627\u0644\u0635\u0641\u0631',
            value: 'A',
          },
          {
            label:
              '\u062a\u063a\u064a\u064a\u0631 \u062c\u0648\u0647\u0631\u064a \u0641\u064a \u0627\u0644\u0627\u0633\u062a\u0631\u0627\u062a\u064a\u062c\u064a\u0629 \u0623\u0648 \u0627\u0644\u0645\u0646\u062a\u062c \u0628\u0646\u0627\u0621\u064b \u0639\u0644\u0649 \u0645\u0627 \u062a\u0639\u0644\u0645\u062a\u0647 \u0645\u0646 \u0627\u0644\u0633\u0648\u0642',
            value: 'B',
          },
          {
            label:
          ...
          {
            label:
              '\u062a\u063a\u064a\u064a\u0631 \u0627\u0633\u0645 \u0627\u0644\u0634\u0631\u0643\u0629 \u0641\u0642\u0637',
            value: 'D',
          },
        ],
        answer: ['B'],
        analysis:
          '\u0627\u0644\u0645\u062d\u0648\u0631 \u0647\u0648 \u062a\u063a\u064a\u064a\u0631 \u062c\u0648\u0647\u0631\u064a \u0641\u064a \u0627\u0633\u062a\u0631\u0627\u062a\u064a\u062c\u064a\u062a\u0643 \u0628\u0646\u0627\u0621\u064b \u0639\u0644\u0649 \u0628\u064a\u0627\u0646\u0627\u062a \u062d\u0642\u064a\u0642\u064a\u0629 \u0645\u0646 \u0627\u0644\u0633\u0648\u0642. \u0644\u064a\u0633 \u0641\u0634\u0644\u0627\u064b \u0628\u0644 \u062a\u0643\u064a\u0651\u0641 \u0630\u0643\u064a. \u0645\u062b\u0627\u0644: Slack \u0628\u062f\u0623\u062a \u0643\u0634\u0631\u0643\u0629 \u0623\u0644\u0639\u0627\u0628 \u0641\u064a\u062f\u064a\u0648\u060c \u0644\u0643\u0646\u0647\u0627 \u062a\u062d\u0648\u0644\u062a \u0644\u0645\u0646\u0635\u0629 \u062a\u0648\u0627\u0635\u0644 \u0645\u0647\u0646\u064a.',
        hasAnswer: true,
        points: 2,
      },
      {
        ...
        type: 'short_answer',
        question:
          '\u0627\u0634\u0631\u062d \u0628\u0643\u0644\u0645\u0627\u062a\u0643 \u0627\u0644\u062e\u0627\u0635\u0629: \u0644\u0645\u0627\u0630\u0627 \u0645\u0646 \u0627\u0644\u0645\u0647\u0645 \u0627\u0644\u062a\u062d\u062f\u062b \u0645\u0639 \u0627\u0644\u0639\u0645\u0644\u0627\u0621 \u0627\u0644\u0645\u062d\u062a\u0645\u0644\u064a\u0646 \u0642\u0628\u0644 \u0628\u0646\u0627\u0621 \u0627\u0644\u0645\u0646\u062a\u062c\u061f',
        commentPrompt:
          '\u064a\u062c\u0628 \u0623\u0646 \u064a\u0630\u0643\u0631 \u0627\u0644\u0645\u062a\u0639\u0644\u0645 \u0623\u0647\u0645\u064a\u0629 \u0627\u0644\u062a\u062d\u0642\u0642 \u0645\u0646 \u0648\u062c\u0648\u062f \u0627\u0644\u0645\u0634\u0643\u0644\u0629 \u0641\u0639\u0644\u0627\u064b \u0639\u0646\u062f \u0627\u0644\u0639\u0645\u0644\u0627\u0621\u060c \u0648\u0641\u0647\u0645 \u0627\u062d\u062a\u064a\u0627\u062c\u0627\u062a\u0647\u0645 \u0627\u0644\u062d\u0642\u064a\u0642\u064a\u0629 \u0628\u062f\u0644 \u0627\u0644\u0627\u0641\u062a\u0631\u0627\u0636\u0627\u062a\u060c \u0648\u062a\u0648\u0641\u064a\u0631 \u0627\u0644\u0648\u0642\u062a \u0648\u0627\u0644\u0645\u0627\u0644 \u0628\u062a\u062c\u0646\u0628 \u0628\u0646\u0627\u0621 \u0634\u064a\u0621 \u0644\u0627 \u064a\u0631\u064a\u062f\u0647 \u0623\u062d\u062f.',
        analysis:
          '\u0627\u0644\u062a\u062d\u062f\u062b \u0645\u0639 \u0627\u0644\u0639\u0645\u0644\u0627\u0621 \u0627\u0644\u0645\u062d\u062a\u0645\u0644\u064a\u0646 \u0642\u0628\u0644 \u0627\u0644\u0628\u0646\u0627\u0621 \u064a\u0633\u0627\u0639\u062f\u0643 \u0639\u0644\u0649: \u0627\u0644\u062a\u062d\u0642\u0642 \u0645\u0646 \u0623\u0646 \u0627\u0644\u0645\u0634\u0643\u0644\u0629 \u062d\u0642\u064a\u0642\u064a\u0629 \u0648\u0644\u064a\u0633\u062a \u0627\u0641\u062a\u0631\u0627\u0636\u0627\u064b \u0641\u064a \u0630\u0647\u0646\u0643 \u0641\u0642\u0637\u060c \u0641\u0647\u0645 \u0643\u064a\u0641 \u064a\u062d\u0644\u0648\u0646 \u0627\u0644\u0645\u0634\u0643\u0644\u0629 \u062d\u0627\u0644\u064a\u0627\u064b\u060c \u0627\u0643\u062a\u0634\u0627\u0641 \u0645\u0627 \u0647\u0645 \u0645\u0633\u062a\u0639\u062f\u0648\u0646 \u0644\u062f\u0641\u0639 \u062b\u0645\u0646\u0647\u060c \u0648\u062a\u0648\u0641\u064a\u0631 \u0623\u0634\u0647\u0631 \u0645\u0646 \u0627\u0644\u0639\u0645\u0644 \u0648\u0627\u0644\u0645\u0627\u0644 \u0639\u0644\u0649 \u0645\u0646\u062a\u062c \u0642\u062f \u0644\u0627 \u064a\u0631\u064a\u062f\u0647 \u0623\u062d\u062f.',
        hasAnswer: false,
        points: 3,
      },
    ],
  ...
  actions: [
    speechAction(
      'd2s2-a1',
      '\u062d\u0627\u0646 \u0648\u0642\u062a \u0627\u0644\u0627\u062e\u062a\u0628\u0627\u0631. \u0647\u0630\u0647 \u0623\u0631\u0628\u0639\u0629 \u0623\u0633\u0626\u0644\u0629 \u062d\u0648\u0644 \u0645\u0646\u0647\u062c\u064a\u0629 \u0627\u0644\u0634\u0631\u0643\u0629 \u0627\u0644\u0646\u0627\u0634\u0626\u0629 \u0627\u0644\u0631\u0634\u064a\u0642\u0629 \u0623\u0648 \u0645\u0627 \u064a\u0639\u0631\u0641 \u0628\u0627\u0644\u0640 Lean Startup. \u062e\u0630 \u0648\u0642\u062a\u0643 \u0641\u064a \u0627\u0644\u062a\u0641\u0643\u064a\u0631 \u0641\u064a \u0643\u0644 \u0633\u0624\u0627\u0644.',
    ),
  ],
  createdAt: Date.now() - 86400000 * 2,
  updatedAt: Date.now() - 86400000 * 2,
...
const demo2Scene3a: SceneRecord = {
  ...
  actions: [
    speechAction(
      'd2s3a-a1',
      '\u0627\u0644\u062e\u0637\u0648\u0629 \u0627\u0644\u0623\u0648\u0644\u0649 \u0641\u064a \u0631\u064a\u0627\u062f\u0629 \u0627\u0644\u0623\u0639\u0645\u0627\u0644 \u0647\u064a \u0627\u0643\u062a\u0634\u0627\u0641 \u0645\u0634\u0643\u0644\u0629 \u062d\u0642\u064a\u0642\u064a\u0629. \u0644\u0627\u062d\u0638 \u0645\u0634\u0627\u0643\u0644\u0643 \u0627\u0644\u064a\u0648\u0645\u064a\u0629\u060c \u062a\u062d\u062f\u062b \u0645\u0639 \u0639\u0634\u0631\u064a\u0646 \u0634\u062e\u0635\u0627\u064b \u0639\u0644\u0649 \u0627\u0644\u0623\u0642\u0644\u060c \u0648\u0627\u0628\u062d\u062b \u0641\u064a \u0627\u0644\u0645\u0646\u062a\u062f\u064a\u0627\u062a. \u0625\u0630\u0627 \u0643\u0627\u0646 \u0627\u0644\u0646\u0627\u0633 \u064a\u062f\u0641\u0639\u0648\u0646 \u062b\u0645\u0646 \u062d\u0644 \u0633\u064a\u0621 \u062d\u0627\u0644\u064a\u0627\u064b\u060c \u0641\u0647\u0630\u0647 \u0641\u0631\u0635\u0629 \u0630\u0647\u0628\u064a\u0629 \u0644\u0643.',
    ),
  ],
  createdAt: Date.now() - 86400000 * 2,
  updatedAt: Date.now() - 86400000 * 2,
...
const demo2Scene3b: SceneRecord = {
  ...
  content: {
    ...
    canvas: makeSlide('d2s3-slide2', THEME_AR, [
      ...
      textEl(
        'd2s3-s2-title',
        '\u0628\u0646\u0627\u0621 \u0627\u0644\u0645\u0646\u062a\u062c \u0627\u0644\u0623\u062f\u0646\u0649 \u0627\u0644\u0642\u0627\u0628\u0644 \u0644\u0644\u062a\u0637\u0628\u064a\u0642',
        {
          left: 80,
          top: 90,
          width: 840,
  ...
  actions: [
    speechAction(
      'd2s3b-a1',
      '\u0627\u0644\u062e\u0637\u0648\u0629 \u0627\u0644\u062b\u0627\u0646\u064a\u0629 \u0647\u064a \u0628\u0646\u0627\u0621 \u0627\u0644\u0645\u0646\u062a\u062c \u0627\u0644\u0623\u062f\u0646\u0649 \u0627\u0644\u0642\u0627\u0628\u0644 \u0644\u0644\u062a\u0637\u0628\u064a\u0642. \u0627\u0644\u0642\u0627\u0639\u062f\u0629 \u0627\u0644\u0630\u0647\u0628\u064a\u0629: \u0627\u0628\u0646\u0650 \u0623\u0642\u0644 \u0645\u0627 \u064a\u0645\u0643\u0646\u0643. \u0641\u064a \u0627\u0644\u0623\u0633\u0628\u0648\u0639 \u0627\u0644\u0623\u0648\u0644\u060c \u0623\u0646\u0634\u0626 \u0635\u0641\u062d\u0629 \u0647\u0628\u0648\u0637 \u0628\u0633\u064a\u0637\u0629. \u0641\u064a \u0627\u0644\u0623\u0633\u0628\u0648\u0639 \u0627\u0644\u062b\u0627\u0646\u064a\u060c \u0642\u062f\u0651\u0645 \u0627\u0644\u062e\u062f\u0645\u0629 \u064a\u062f\u0648\u064a\u0627\u064b \u0644\u0639\u0634\u0631\u0629 \u0639\u0645\u0644\u0627\u0621. \u0644\u0627 \u062a\u0646\u062a\u0638\u0631 \u0627\u0644\u0643\u0645\u0627\u0644 \u2014 \u0627\u0644\u0643\u0645\u0627\u0644 \u0639\u062f\u0648 \u0627\u0644\u062a\u0642\u062f\u0645.',
    ),
  ],
  createdAt: Date.now() - 86400000 * 2,
  updatedAt: Date.now() - 86400000 * 2,
...
const demo2Scene3c: SceneRecord = {
  ...
  actions: [
    speechAction(
      'd2s3c-a1',
      '\u0627\u0644\u062e\u0637\u0648\u0629 \u0627\u0644\u062b\u0627\u0644\u062b\u0629 \u0647\u064a \u0627\u0644\u0646\u0645\u0648 \u0648\u062c\u0645\u0639 \u0627\u0644\u062a\u0645\u0648\u064a\u0644. \u0644\u0643\u0646 \u0627\u0646\u062a\u0628\u0647: \u0644\u0627 \u062a\u0628\u062d\u062b \u0639\u0646 \u062a\u0645\u0648\u064a\u0644 \u0642\u0628\u0644 \u0623\u0646 \u064a\u0643\u0648\u0646 \u0644\u062f\u064a\u0643 \u0639\u0645\u0644\u0627\u0621 \u064a\u062f\u0641\u0639\u0648\u0646. \u0627\u0628\u062f\u0623 \u0628\u0645\u062f\u062e\u0631\u0627\u062a\u0643\u060c \u062b\u0645 \u0627\u0628\u062d\u062b \u0639\u0646 \u0645\u0646\u062d \u0648\u0645\u0633\u0627\u0628\u0642\u0627\u062a\u060c \u0648\u0628\u0639\u062f\u0647\u0627 \u0641\u0643\u0651\u0631 \u0641\u064a \u0627\u0644\u0645\u0633\u062a\u062b\u0645\u0631\u064a\u0646. \u0627\u0644\u062a\u0645\u0648\u064a\u0644 \u0644\u0644\u062a\u0648\u0633\u0639 \u0648\u0644\u064a\u0633 \u0644\u0644\u0628\u062f\u0621.',
    ),
  ],
  createdAt: Date.now() - 86400000 * 2,
  updatedAt: Date.now() - 86400000 * 2,
  ...
  content: {
    ...
    canvas: makeSlide(
      ...
      [
        ...
        textEl(
          'd3s1-s1-stat1',
          '<strong>92% of Fortune 500 companies</strong> now use AI tools in daily operations',
          {
            left: 80,
            top: 210,
            width: 840,
        ...
        textEl(
          'd3s1-s1-stat3',
          '<strong>Average productivity gain: 37%</strong> for teams using AI-assisted workflows',
          {
            left: 80,
            top: 320,
            width: 840,
        ...
        textEl(
          'd3s1-s1-key',
          'The question is no longer "should we use AI?" \u2014 it\'s "which AI tools, and how?"',
          {
            left: 80,
            top: 420,
            width: 840,
  ...
  content: {
    ...
    canvas: makeSlide(
      ...
      [
        ...
        textEl(
          'd3s1-s2-c1',
          '<strong>AI Assistants</strong><br/>Claude, ChatGPT, Gemini<br/>General-purpose reasoning & writing',
          {
            left: 60,
            top: 120,
            width: 280,
        ...
        textEl(
          'd3s1-s2-c2',
          '<strong>Content & Copy</strong><br/>Jasper, Copy.ai, Writer<br/>Marketing copy, blog posts, ads',
          {
            left: 360,
            top: 120,
            width: 280,
        ...
        textEl(
          'd3s1-s2-c3',
          '<strong>Design & Visual</strong><br/>Midjourney, DALL-E, Canva AI<br/>Images, presentations, branding',
          {
            left: 660,
            top: 120,
            width: 280,
        ...
        textEl(
          'd3s1-s2-c4',
          '<strong>Data & Analytics</strong><br/>Julius, Hex, Coefficient<br/>Data analysis, dashboards, insights',
          {
            left: 60,
            top: 290,
            width: 280,
        ...
        textEl(
          'd3s1-s2-c5',
          '<strong>Automation</strong><br/>n8n, Zapier AI, Make<br/>Workflow automation with AI logic',
          {
            left: 360,
            top: 290,
            width: 280,
        ...
        textEl(
          'd3s1-s2-c6',
          '<strong>Sales & CRM</strong><br/>Apollo AI, Gong, Clay<br/>Lead gen, call analysis, outreach',
          {
            left: 660,
            top: 290,
            width: 280,
        ...
        textEl(
          'd3s1-s2-tip',
          "Start with 1-2 categories that match your biggest bottleneck. Don't try to adopt everything at once.",
          {
            left: 80,
            top: 460,
            width: 840,
...
const demo3Scene1c: SceneRecord = {
  ...
  content: {
    ...
    canvas: makeSlide(
      ...
      [
        ...
        textEl(
          'd3s1-s3-marketing',
          '<strong>Marketing</strong><br/>Generate 50 ad variations in 10 minutes (Jasper + Claude)<br/>Auto-create social media calendars from blog content<br/>Personalize email campaigns at scale with AI segmentation',
          {
            left: 60,
            top: 120,
            width: 420,
        ...
        textEl(
          'd3s1-s3-sales',
          '<strong>Sales</strong><br/>Auto-research prospects before calls (Clay + Apollo)<br/>Analyze call recordings for winning patterns (Gong)<br/>Generate personalized outreach sequences in seconds',
          {
            left: 520,
            top: 120,
            width: 420,
        ...
        textEl(
          'd3s1-s3-ops',
          '<strong>Operations</strong><br/>Automate invoice processing and data entry (n8n)<br/>Generate weekly reports from raw data automatically<br/>Route customer support tickets with AI classification',
          {
            left: 60,
            top: 300,
            width: 420,
        ...
        textEl(
          'd3s1-s3-strategy',
          '<strong>Strategy</strong><br/>Analyze competitor moves from public data<br/>Summarize 100-page reports in 2 minutes (Claude)<br/>Model scenarios and financial projections',
          {
            left: 520,
            top: 300,
            width: 420,
        ...
        textEl(
          'd3s1-s3-bottom',
          "Key insight: AI amplifies your team \u2014 it doesn't replace it. The best results come from human + AI collaboration.",
          {
            left: 80,
            top: 475,
            width: 840,
  ...
  actions: [
    speechAction(
      'd3s1c-a1',
      "Let's look at real use cases by department. Marketing teams can generate 50 ad variations in 10 minutes. Sales teams can auto-research prospects before calls. Operations can automate invoice processing. And strategy teams can summarize 100-page reports in 2 minutes. Remember: AI amplifies your team, it doesn't replace it.",
    ),
...
const demo3Scene2: SceneRecord = {
  ...
  actions: [
    speechAction(
      'd3s2-a1',
      "Now let's find the right AI tools for your specific needs. This interactive selector will ask you three quick questions about your business need, team size, and budget, then recommend a personalized AI stack with pros and cons for each tool.",
    ),
  ],
  createdAt: Date.now() - 86400000,
  updatedAt: Date.now() - 86400000,
...
const demo3Scene3: SceneRecord = {
    ...
    questions: [
      {
        ...
        answer: ['B'],
        analysis:
          "AI-assisted email marketing and customer segmentation consistently delivers the highest ROI for small businesses. It combines the proven high-ROI channel (email) with AI's ability to personalize at scale. Segmenting customers by behavior and preferences can increase email revenue by 760%.",
        hasAnswer: true,
        points: 2,
      },
      {
        ...
        answer: ['C'],
        analysis:
          'The most successful AI implementations follow an incremental approach: start with one high-impact use case, measure results, build team confidence, then expand. Trying to transform everything at once leads to change fatigue, poor adoption, and wasted budget.',
        hasAnswer: true,
        points: 2,
      },
      {
        ...
        type: 'short_answer',
        question:
          'Describe one specific way you could use an AI assistant (like Claude) to save at least 5 hours per week in your current role.',
        commentPrompt:
          'Look for a specific, realistic use case with a clear before/after comparison. Good answers mention a concrete task (e.g., writing meeting summaries, drafting proposals, analyzing spreadsheets), how they currently do it, and how AI would help.',
        analysis:
          'Common high-impact examples include: drafting meeting summaries from notes (saves 3-4 hours/week), writing first drafts of proposals and reports (saves 5-8 hours/week), analyzing spreadsheet data and creating summaries (saves 2-3 hours/week), researching competitors or market trends (saves 4-5 hours/week), and generating personalized email responses (saves 2-3 hours/week).',
        hasAnswer: false,
        points: 3,
      },
      {
        ...
        options: [
          ...
          {
            label:
              'Sensitive business data shared with AI providers may create privacy and compliance risks',
            value: 'B',
          },
      ...
      },
      {
        ...
        options: [
          ...
          {
            label:
              'The skill of crafting effective instructions to get better outputs from AI tools',
            value: 'B',
          },
  ...
  actions: [
    speechAction(
      'd3s3-a1',
      "Let's test your understanding of AI applications in business. This quiz covers practical implementation principles, real-world use cases, and important considerations when adopting AI tools. Take your time with each question.",
    ),
  ],
  createdAt: Date.now() - 86400000,
  updatedAt: Date.now() - 86400000,
