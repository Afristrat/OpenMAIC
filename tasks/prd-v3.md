...
- 19 demandes/ensembles d’engagements rattachés à des US.
- 65 US au registre : 13 à implémenter, 26 à valider, 21 avec décision préalable et 5 bloquées ; 11 sont soldées.
...
| 4    | S6-017 | P0       | À implémenter    | Éliminer les vulnérabilités critiques et hautes des dépendances de production         |
| 5    | S6-014 | P0       | Bloquée          | Conserver la dette de sécurité Qalem sous autorisation explicite                      |
| 6    | S6-018 | P1       | À implémenter    | Supprimer les erreurs serveur parasites des E2E à fallback IndexedDB                  |
| 7    | S6-005 | P1       | Soldée           | Proposer une reformulation fondée sur les sources en cas de conflit                   |
| 8    | S6-006 | P1       | Soldée           | Maintenir l’ancrage documentaire jusqu’aux scènes et à leur édition                   |
| 9    | S6-007 | P1       | Soldée           | Créer les illustrations sans réutiliser les images du document source                 |
| 10   | S6-008 | P1       | Soldée           | Afficher dirhams et prononcer le mot sans s final                                     |
| 11   | S5-004 | P1       | Soldée           | Plan auteur obligatoire et ingestion documentaire fiable [UI]                         |
| 12   | S6-009 | P1       | À valider        | Recetter Whisper sur de la parole réelle et le parcours microphone                    |
| 13   | S6-003 | P1       | Bloquée          | Consommer Diwan par un contrat documentaire autonome                                  |
| 14   | S6-004 | P1       | Soldée           | Bibliothèque et sélection de plusieurs sources par formation                          |
| 15   | S6-012 | P1       | À valider        | Qualifier le catalogue vocal français et anglais                                      |
| 16   | S1-009 | P1       | Soldée           | Gate audio : tachkil AR + plancher de bruit -50 dB sur toutes les sorties TTS         |
| 17   | S4-010 | P1       | Soldée           | Contexte territorial réutilisable et guidage laser lisible [UI]                       |
| 18   | S0-017 | P1       | À valider        | Modèles image LiteLLM administrés : libellés, sélection et preuve UI [UI]             |
| 19   | S6-013 | P1       | À valider        | Recetter une formation complète avec ressources et exports réels                      |
| 20   | S-025  | P1       | Soldée           | Extraire les items de révision depuis les quiz                                        |
| 21   | S6-010 | P1       | Soldée           | Déclencher les rappels de révision et vérifier le cache PWA                           |
| 22   | U-020  | P1       | À valider        | Bannière installer PWA                                                                |
| 23   | S3-002 | P1       | À valider        | Push PWA re-vérifié sur appareils réels iOS + Android                                 |
| 24   | S0-012 | P1       | À valider        | [CHECKPOINT AMINE] Parcours guidé passe RTL ar-MA [UI]                                |
| 25   | S1-012 | P1       | À valider        | Capacité capture web réutilisable — service Playwright dédié + injection scène        |
| 26   | S0-011 | P2       | Décision requise | [CHECKPOINT AMINE] Checklist garder/abandonner des 72 stories                         |
| 27   | S1-007 | P2       | À valider        | Export SCORM couche 1 : package autonome importé dans Moodle                          |
| 28   | S1-008 | P2       | À valider        | Export couche 2 : adaptateurs scorm12/scorm2004/cmi5 interchangeables                 |
| 29   | S1-010 | P2       | À valider        | Export PPTX re-vérifié sur la nouvelle base                                           |
| 30   | S1-004 | P2       | À valider        | Catalogue interne (porte 2) [UI]                                                      |
| 31   | S1-005 | P2       | À implémenter    | Import → outline éditable (porte 3)                                                   |
| 32   | S6-016 | P2       | Décision requise | Clore le cadrage NP des widgets à partir du produit actuel                            |
| 33   | S6-015 | P2       | Décision requise | Composer et publier des widgets déterministes sans redéploiement                      |
| 34   | S6-011 | P2       | Décision requise | Réconcilier puis livrer les canaux de rappel e-mail et WhatsApp retenus               |
| 35   | S2-004 | P2       | Bloquée          | [GATE DPIA] Enregistrement du live : flux d'événements complet (agents + utilisateur) |
| 36   | S2-005 | P2       | À implémenter    | Replay fidèle « comme un vrai webinaire » (streaming, jamais de téléchargement)       |
| 37   | S2-006 | P2       | À implémenter    | Bibliothèque de replays (reprise, suppression effective) [UI]                         |
| 38   | S2-008 | P2       | Bloquée          | Watermark sonore AudioSeal MIT en job BullMQ (protocole de robustesse)                |
| 39   | S2-009 | P2       | À valider        | Watermark visuel indélébile                                                           |
| 40   | S2-011 | P2       | Décision requise | [CHECKPOINT AMINE] Référentiels culture → prénoms validés                             |
| 41   | S3-001 | P2       | À implémenter    | Tables d'ancrage (seeds, anchor_plans, anchor_deliveries, evaluations, xapi_outbox)   |
| 42   | S3-003 | P2       | À implémenter    | Évaluation à chaud en fin de session [UI]                                             |
| 43   | S3-004 | P2       | À implémenter    | Générateur de graines : stock complet à la fin de session                             |
| 44   | S3-005 | P2       | À implémenter    | Plan d'ancrage opt-in + planification BullMQ ≤ J+90                                   |
| 45   | S3-006 | P2       | À implémenter    | Rappels quiz espacés via FSRS porté (cycle complet)                                   |
| 46   | S3-007 | P2       | À implémenter    | Évaluations à froid J+30 / J+60                                                       |
| 47   | S3-008 | P2       | Décision requise | [CHECKPOINT AMINE] Ton des graines + fréquences validés sur échantillon               |
| 48   | S3-009 | P2       | À implémenter    | Reporting ancrage : agrégats org uniquement [UI]                                      |
| 49   | S3-010 | P2       | À implémenter    | Émission xAPI via outbox (retry, acteur pseudonymisé)                                 |
| 50   | U-007  | P2       | Décision requise | Bouton certificat dans classroom                                                      |
| 51   | U-008  | P2       | À valider        | Page Mes certificats                                                                  |
| 52   | U-021  | P2       | Décision requise | Bannière consentement télémétrie RGPD                                                 |
| 53   | S-018  | P3       | Décision requise | Implémenter le MCP Client pour serveurs externes                                      |
| 54   | S-019  | P3       | Décision requise | Connecter NotebookLM via MCP                                                          |
| 55   | S-020  | P3       | Décision requise | Connecter Notion via MCP                                                              |
| 56   | S-021  | P3       | Décision requise | Connecter Google Drive via MCP                                                        |
| 57   | S-034  | P3       | Décision requise | LTI Assignment and Grade Services (AGS)                                               |
| 58   | S-035  | P3       | Décision requise | Télémétrie xAPI                                                                       |
| 59   | S-036  | P3       | Décision requise | Pipeline de collecte de données pédagogiques                                          |
| 60   | S-037  | P3       | Décision requise | Optimisation pipeline de génération par les données                                   |
| 61   | S-047  | P3       | Décision requise | Collecte des patterns de discussion multi-agent                                       |
| 62   | S-048  | P3       | Décision requise | Director data-driven                                                                  |
| 63   | U-011  | P3       | Décision requise | Publier un agent sur la marketplace                                                   |
| 64   | U-015  | P3       | Décision requise | Configuration MCP dans admin                                                          |
| 65   | U-018  | P3       | Décision requise | Widget xAPI status                                                                    |
