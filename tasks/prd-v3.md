...
| 16   | S6-012 | P1       | Soldée           | Qualifier le catalogue vocal français et anglais                                      |
...
| 36   | S2-004 | P2       | Soldée           | [GATE DPIA] Enregistrement du live : flux d'événements complet (agents + utilisateur) |
...
| 54   | S-018  | P3       | Soldé           | Implémenter le MCP Client pour serveurs externes                                      |
...
| 63   | S-048  | P3       | Code en cours, autorisé le 9 septembre | Director data-driven — raccordement et restitution UI codés ; suivi A/B et validation intégrée restent ouverts |
