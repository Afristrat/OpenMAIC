...
- 18 demandes/ensembles d’engagements rattachés à des US.
- 64 US au registre : 12 à implémenter, 15 à valider, 21 avec décision préalable, 5 bloquées et 11 soldées.
...
| 6    | S6-005 | P1       | Soldée           | Proposer une reformulation fondée sur les sources en cas de conflit                   |
| 7    | S6-006 | P1       | Soldée           | Maintenir l’ancrage documentaire jusqu’aux scènes et à leur édition                   |
| 8    | S6-007 | P1       | Soldée           | Créer les illustrations sans réutiliser les images du document source                 |
| 9    | S6-008 | P1       | Soldée           | Afficher dirhams et prononcer le mot sans s final                                     |
| 10   | S5-004 | P1       | Soldée           | Plan auteur obligatoire et ingestion documentaire fiable [UI]                         |
| 11   | S6-009 | P1       | À valider        | Recetter Whisper sur de la parole réelle et le parcours microphone                    |
| 12   | S6-003 | P1       | Bloquée          | Consommer Diwan par un contrat documentaire autonome                                  |
| 13   | S6-004 | P1       | Soldée           | Bibliothèque et sélection de plusieurs sources par formation                          |
| 14   | S6-012 | P1       | À valider        | Qualifier le catalogue vocal français et anglais                                      |
| 15   | S1-009 | P1       | Soldée           | Gate audio : tachkil AR + plancher de bruit -50 dB sur toutes les sorties TTS         |
| 16   | S4-010 | P1       | Soldée           | Contexte territorial réutilisable et guidage laser lisible [UI]                       |
| 17   | S0-017 | P1       | À valider        | Modèles image LiteLLM administrés : libellés, sélection et preuve UI [UI]             |
| 18   | S6-013 | P1       | À valider        | Recetter une formation complète avec ressources et exports réels                      |
| 19   | S-025  | P1       | Soldée           | Extraire les items de révision depuis les quiz                                        |
| 20   | S6-010 | P1       | Soldée           | Déclencher les rappels de révision et vérifier le cache PWA                           |
| 21   | U-020  | P1       | À valider        | Bannière installer PWA                                                                |
| 22   | S3-002 | P1       | À valider        | Push PWA re-vérifié sur appareils réels iOS + Android                                 |
| 23   | S0-012 | P1       | À valider        | [CHECKPOINT AMINE] Parcours guidé passe RTL ar-MA [UI]                                |
| 24   | S1-012 | P1       | À valider        | Capacité capture web réutilisable — service Playwright dédié + injection scène        |
| 25   | S0-011 | P2       | Décision requise | [CHECKPOINT AMINE] Checklist garder/abandonner des 72 stories                         |
| 26   | S1-007 | P2       | À valider        | Export SCORM couche 1 : package autonome importé dans Moodle                          |
| 27   | S1-008 | P2       | À valider        | Export couche 2 : adaptateurs scorm12/scorm2004/cmi5 interchangeables                 |
| 28   | S1-010 | P2       | À valider        | Export PPTX re-vérifié sur la nouvelle base                                           |
| 29   | S1-004 | P2       | À valider        | Catalogue interne (porte 2) [UI]                                                      |
| 30   | S1-005 | P2       | À implémenter    | Import → outline éditable (porte 3)                                                   |
| 31   | S6-016 | P2       | Décision requise | Clore le cadrage NP des widgets à partir du produit actuel                            |
| 32   | S6-015 | P2       | Décision requise | Composer et publier des widgets déterministes sans redéploiement                      |
| 33   | S6-011 | P2       | Décision requise | Réconcilier puis livrer les canaux de rappel e-mail et WhatsApp retenus               |
| 34   | S2-004 | P2       | Bloquée          | [GATE DPIA] Enregistrement du live : flux d'événements complet (agents + utilisateur) |
| 35   | S2-005 | P2       | À implémenter    | Replay fidèle « comme un vrai webinaire » (streaming, jamais de téléchargement)       |
| 36   | S2-006 | P2       | À implémenter    | Bibliothèque de replays (reprise, suppression effective) [UI]                         |
| 37   | S2-008 | P2       | Bloquée          | Watermark sonore AudioSeal MIT en job BullMQ (protocole de robustesse)                |
| 38   | S2-009 | P2       | À valider        | Watermark visuel indélébile                                                           |
| 39   | S2-011 | P2       | Décision requise | [CHECKPOINT AMINE] Référentiels culture → prénoms validés                             |
| 40   | S3-001 | P2       | À implémenter    | Tables d'ancrage (seeds, anchor_plans, anchor_deliveries, evaluations, xapi_outbox)   |
| 41   | S3-003 | P2       | À implémenter    | Évaluation à chaud en fin de session [UI]                                             |
| 42   | S3-004 | P2       | À implémenter    | Générateur de graines : stock complet à la fin de session                             |
| 43   | S3-005 | P2       | À implémenter    | Plan d'ancrage opt-in + planification BullMQ ≤ J+90                                   |
| 44   | S3-006 | P2       | À implémenter    | Rappels quiz espacés via FSRS porté (cycle complet)                                   |
| 45   | S3-007 | P2       | À implémenter    | Évaluations à froid J+30 / J+60                                                       |
| 46   | S3-008 | P2       | Décision requise | [CHECKPOINT AMINE] Ton des graines + fréquences validés sur échantillon               |
| 47   | S3-009 | P2       | À implémenter    | Reporting ancrage : agrégats org uniquement [UI]                                      |
| 48   | S3-010 | P2       | À implémenter    | Émission xAPI via outbox (retry, acteur pseudonymisé)                                 |
| 49   | U-007  | P2       | Décision requise | Bouton certificat dans classroom                                                      |
| 50   | U-008  | P2       | À valider        | Page Mes certificats                                                                  |
| 51   | U-021  | P2       | Décision requise | Bannière consentement télémétrie RGPD                                                 |
| 52   | S-018  | P3       | Décision requise | Implémenter le MCP Client pour serveurs externes                                      |
| 53   | S-019  | P3       | Décision requise | Connecter NotebookLM via MCP                                                          |
| 54   | S-020  | P3       | Décision requise | Connecter Notion via MCP                                                              |
| 55   | S-021  | P3       | Décision requise | Connecter Google Drive via MCP                                                        |
| 56   | S-034  | P3       | Décision requise | LTI Assignment and Grade Services (AGS)                                               |
| 57   | S-035  | P3       | Décision requise | Télémétrie xAPI                                                                       |
| 58   | S-036  | P3       | Décision requise | Pipeline de collecte de données pédagogiques                                          |
| 59   | S-037  | P3       | Décision requise | Optimisation pipeline de génération par les données                                   |
| 60   | S-047  | P3       | Décision requise | Collecte des patterns de discussion multi-agent                                       |
| 61   | S-048  | P3       | Décision requise | Director data-driven                                                                  |
| 62   | U-011  | P3       | Décision requise | Publier un agent sur la marketplace                                                   |
| 63   | U-015  | P3       | Décision requise | Configuration MCP dans admin                                                          |
| 64   | U-018  | P3       | Décision requise | Widget xAPI status                                                                    |
