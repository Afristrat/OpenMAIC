...
| S3-004 | Générateur de graines (stock à la fin de session) | Une session vécue → ≥ 12 graines typées citant les scènes sources, dans le registre des personas du casting ; coût LLM d'une génération consigné |
...
| Kirkpatrick L4 (impact business) | Premier client fournissant ses données métier |
| Regénération de graines (stock épuisé/répétitif) | Mesure de répétitivité sur pilote (hypothèse 2 de l'app-spec réfutée) |
| Lien Bloom → FSRS complet (dette extracteur) | S3-006 révèle la limite en usage réel → story de pioche dédiée |
