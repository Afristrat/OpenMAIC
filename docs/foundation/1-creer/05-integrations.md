...
| `scorm-again` (lib npm, jcputney) | Runtime SCORM 1.2/2004 des packages exportés (couche 1) | — | MIT, lib archivée localement | Oui (export seulement) | `EscolaLMS/Scorm-player` évalué en second (ADR-102) |
