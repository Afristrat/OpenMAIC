...
4. **Encore ouvert** : importer les nouveaux secrets avec l’outil officiel du coffre lorsque le presse-papier est accessible ; ne pas les recréer pour contourner cet obstacle. Dérogation limitée à son paramètre `-Value`, alimenté en mémoire sans affichage ni rotation, demandée à Amine et non encore reçue.
