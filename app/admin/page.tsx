...
import { getProviderTypeLabel } from '@/components/settings/utils';
      ...
      case 'mcp':
        return (
          <>
            ...
            <h2 className="text-lg font-semibold">{t('admin.mcp.title')}</h2>
          </>
        );
      case 'lti':
        return (
          <>
            ...
            <h2 className="text-lg font-semibold">{t('admin.lti.title')}</h2>
          </>
        );
      case 'pedagogy':
        return (
          <>
            ...
            <h2 className="text-lg font-semibold">{t('admin.pedagogy.title')}</h2>
          </>
        );
      case 'xapi':
        return (
          <>
            ...
            <h2 className="text-lg font-semibold">{t('admin.xapi.title')}</h2>
          </>
        );
      default:
        return null;
      ...
      <div className="flex h-[100dvh] overflow-hidden">
        ...
        <div className="flex-shrink-0 bg-muted/30 p-3 space-y-1 border-r border-border/40" style={{ width: sidebarWidth }}>
          ...
          >
            ...
            <span className="truncate">{t('admin.mcp.title')}</span>
          </button>
          ...
          >
            ...
            <span className="truncate">{t('admin.lti.title')}</span>
          </button>

          <button
            onClick={() => setActiveSection('pedagogy')}
            className={cn(
              'w-full flex items-center gap-3 px-3 py-2 text-sm rounded-lg transition-colors text-left min-w-0',
          ...
          >
            ...
            <span className="truncate">{t('admin.pedagogy.title')}</span>
          </button>

          <button
            onClick={() => setActiveSection('xapi')}
            className={cn(
              'w-full flex items-center gap-3 px-3 py-2 text-sm rounded-lg transition-colors text-left min-w-0',
              activeSection === 'xapi'
                ? 'bg-primary/10 text-primary font-medium'
          ...
          >
            ...
            <span className="truncate">{t('admin.xapi.title')}</span>
          </button>
        </div>
        ...
        <div className="flex-1 flex flex-col overflow-hidden min-w-0">
          ...
          <div className="flex-1 overflow-y-auto p-5">
            ...
            {activeSection === 'lti' && <LTITab />}
            {activeSection === 'pedagogy' && <PedagogyTab />}
            {activeSection === 'xapi' && <XAPITab />}
          </div>
        </div>
      </div>
